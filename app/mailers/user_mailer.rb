class UserMailer < ApplicationMailer
  ...
  def contactar_propietario_perdido(perro_perdido, correo_contacto)
    @perro_perdido = perro_perdido
    @correo_contacto = correo_contacto
  
    mail(to: @perro_perdido.mail, subject: '¡Alguien encontró tu perro!')
  end

  def contactar_propietario_encontrado(perro_perdido, correo_contacto)
    @perro_perdido = perro_perdido
    @correo_contacto = correo_contacto
